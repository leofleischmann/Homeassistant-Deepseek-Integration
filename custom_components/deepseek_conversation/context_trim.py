...
turn before messages are sent to DeepSeek. Used from chat_session.py for the
history and from chat_messages.py for tool results. Both limits are off at
zero, which is the only switch either of them needs.
"""
